...
from neural_methods.model.Mamba import Mamba,ModelArgs
...
class MambaTrainer(BaseTrainer):
    ...
    def __init__(self, config, data_loader):
        ...
        if config.TOOLBOX_MODE == "train_and_test":
            self.model = Mamba(ModelArgs(d_model=config.MODEL.MAMBA.D_MODEL, 
                n_layer=config.MODEL.MAMBA.N_LAYER, vocab_size=config.MODEL.MAMBA.V_SIZE)).to(self.device)
